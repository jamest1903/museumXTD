...
tags: ressource 
alias: [Quels musées voulons-nous demain?]
eleventyNavigation:
  key: demain
  title: Quels musées voulons-nous demain?
  parent: culturenum
---
### [Quels musées voulons-nous demain? Le choix nous appartient](https://www.museums.ch/fr/assets/files/dossiers_f/Publikationen/VMS_Zukunft_F_web.pdf)
Ce rapport de l'[AMS](https://www.museums.ch/fr/) liste des questions à se poser en tant que musée afin de mieux cerner l'impact de grandes tendances sociétales (mondialisation, numérisation, individualisation etc.) sur le futur de l'institution. 
...
- Le lexique et la bibliographie en fin de rapport. 
